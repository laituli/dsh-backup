...
async function main() {
  ...
  try {
    ...
    ok(JSON.stringify(endpoints) === JSON.stringify(['backupPanel/status', 'backupPanel/backup', 'backupPanel/verify', 'backupPanel/restore', 'backupPanel/setAuto', 'backupPanel/githubStatus', 'backupPanel/githubSyncNow', 'backupPanel/githubPull', 'backupPanel/removeEntry', 'backupPanel/setGithubRepo', 'backupPanel/cancelSync', 'backupPanel/doctorScan', 'backupPanel/doctorRepair', 'backupPanel/upgradePlan']), `14 个端点齐全: ${endpoints.join(', ')}`);
